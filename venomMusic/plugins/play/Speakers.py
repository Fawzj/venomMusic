...
from venomMusic.core.call import Zelzaly
...
async def strcall(client, message):
    ...
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("./venomMusic/assets/call.mp3"), stream_type=StreamType().pulse_stream)
